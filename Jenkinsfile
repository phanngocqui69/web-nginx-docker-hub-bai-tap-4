pipeline {
    ...
    environment {
        ...
        GIT_REPO_NAME = "github.com/phanngocqui69/web-nginx-docker-hub-bai-tap-4"
                    ...
                    // Loop through each server and deploy the Docker container
                        ...
                        sh '''
                            ...
                            server='192.168.84.154'
                                ...
                                ssh -o StrictHostKeyChecking=no -i ${SSHd_KEY_PATH} ${SSH_USER}@$server "sudo docker pull ${IMAGE_NAME}:${TAG}"
